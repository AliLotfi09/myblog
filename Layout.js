...
const $$TerminalLoading = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$TerminalLoading;
  `
...
async function loadApp() {
  ...
  try {
    await app.load('${Astro2.url.origin}/scene.splinecode');
  } catch(e) {
...
`;
  return renderTemplate(_a || (_a = __template(["", '<div id="loader-container" data-astro-cid-gfr4x44f> <div id="screen" data-astro-cid-gfr4x44f></div> </div> <div id="welcome-screen" data-astro-cid-gfr4x44f>\nWelcome to My Awesome Site\n</div> <div id="canvas-wrapper" data-astro-cid-gfr4x44f> <canvas id="canvas3d" data-astro-cid-gfr4x44f></canvas> </div> <script>\n  ${splineScript}\n<\/script>'], ["", '<div id="loader-container" data-astro-cid-gfr4x44f> <div id="screen" data-astro-cid-gfr4x44f></div> </div> <div id="welcome-screen" data-astro-cid-gfr4x44f>\nWelcome to My Awesome Site\n</div> <div id="canvas-wrapper" data-astro-cid-gfr4x44f> <canvas id="canvas3d" data-astro-cid-gfr4x44f></canvas> </div> <script>\n  \\${splineScript}\n<\/script>'])), maybeRenderHead());
}, "C:/Users/AliLotfi/Desktop/myblog/src/components/TerminalLoading.astro", void 0);
