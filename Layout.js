...
}, "C:/Users/AliLotfi/Downloads/multiterm-astro-main/multiterm-astro-main/src/components/NavLink.astro", void 0);

const $$Header = createComponent(($$result, $$props, $$slots) => {
  const lightDarkAutoTheme = config.themes.mode === "light-dark-auto";
  const selectTheme = config.themes.include.length > 1;
  return renderTemplate`${maybeRenderHead()}<header> <div class="relative flex items-center justify-between bg-accent/10 rounded-xl"> <a id="logo" href="/" class="block px-4 py-1.5 max-w-full no-underline items-center bg-accent text-background font-bold rounded-xl"> ${config.title} </a> <div class="flex items-center gap-3 sm:mr-3"> ${renderComponent($$result, "Search", $$Search, {})} ${lightDarkAutoTheme} ${selectTheme && renderTemplate`${renderComponent($$result, "SelectTheme", $$SelectTheme, {})}`} <nav id="nav-mobile" aria-label="Menu" class="p-0 text-accent sm:hidden"> <button id="nav-mobile-button" class="px-3 py-1 h-full cursor-pointer border-2 rounded-xl bg-background" type="button" aria-expanded="false" aria-controls="nav-menu-list">
▾
</button> <ul id="nav-mobile-list" class="invisible absolute flex flex-col bg-background shadow text-accent border-2 m-0 p-2.5 top-11.5 left-auto right-0 z-50 rounded-xl"> ${config.navLinks.map((link) => renderTemplate`<li class="p-1" aria-expanded="false"> ${renderComponent($$result, "NavLink", $$NavLink, { "link": link })} </li>`)} </ul> </nav> </div> </div> <nav aria-label="Menu" class="p-0 mt-4 ml-0.5 text-accent hidden sm:block"> <ul class="flex flex-row text-accent mb-2.5"> ${config.navLinks.map((link) => renderTemplate`<li class="mr-5" aria-expanded="true"> ${renderComponent($$result, "NavLink", $$NavLink, { "link": link })} </li>`)} </ul> </nav> </header> ${renderScript($$result, "C:/Users/AliLotfi/Downloads/multiterm-astro-main/multiterm-astro-main/src/components/Header.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/Users/AliLotfi/Downloads/multiterm-astro-main/multiterm-astro-main/src/components/Header.astro", void 0);
...
}, "C:/Users/AliLotfi/Downloads/multiterm-astro-main/multiterm-astro-main/src/components/SocialLinks.astro", void 0);
...
}, "C:/Users/AliLotfi/Downloads/multiterm-astro-main/multiterm-astro-main/src/components/Footer.astro", void 0);
...
}, "C:/Users/AliLotfi/Downloads/multiterm-astro-main/multiterm-astro-main/src/components/LightDarkAutoThemeLoader.astro", void 0);
...
}, "C:/Users/AliLotfi/Downloads/multiterm-astro-main/multiterm-astro-main/src/components/SelectThemeLoader.astro", void 0);
